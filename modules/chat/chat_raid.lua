...
-- Class functions
function Chat:Raid_OnEvent(event)
...
function Chat:Raid_Init()
	...
	-- Create frame
	frame = Layout:CreateFrame('ScrollingMessageFrame', 'Chat_Raid', getglobal('ElronsUI_Chat'), w, h)
	...
	frame:SetScript('OnEvent', function() Chat:Raid_OnEvent(event) end)
